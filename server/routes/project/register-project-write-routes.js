...
export const registerProjectWriteRoutes = ({ app, PUBLIC_UPLOADS_DIR, appendAuditLog, applyEpisodePublicationMetadata, applyProjectChapterUpdate, canManageIntegrations, canManageProjects, createRevisionToken, deriveAniListMediaOrganization, dispatchEditorialWebhookEvent, enqueueProjectOgPrewarm, ensureNoEditConflict, fetchAniListMediaById, findDuplicateEpisodeKey, findDuplicateVolumeCover, findProjectChapterByEpisodeNumber, findPublishedImageEpisodeWithoutPages, importRemoteImageFile, isWithinRestoreWindow, localizeProjectImageFields, loadProjects, loadUpdates, loadUploads, mapProjectImageImportExecutionError, normalizeProjectSnapshotForEpubImport, normalizeProjects, parseEditRevisionOptions, requireAuth, resolveEpisodeLookup, resolveProjectWebhookEventKey, runAutoUploadReorganization, writeProjects, writeUpdates, upsertUploadEntries } = {}) => {
