...
const cloneDashboardSettingsCache = (value: Omit<DashboardSettingsCacheEntry, "expiresAt">) => ({
  ...
  linkTypes: JSON.parse(JSON.stringify(value.linkTypes)) as LinkTypeItem[],
});

const readDashboardSettingsCache = () => {
...
const writeDashboardSettingsCache = (value: Omit<DashboardSettingsCacheEntry, "expiresAt">) => {
