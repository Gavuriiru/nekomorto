...
const faqGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Não. Nosso trabalho é feito por paixão e sem fins lucrativos.",
      },
      {
        question: "Qual a prioridade da equipe?",
        answer:
          "Entregar algo bonito, legível e consistente, mesmo que isso leve mais tempo.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Sim! Sempre buscamos pessoas comprometidas. Entre em contato pelo Discord.",
      },
      {
        question: "Preciso ter experiência?",
        answer:
          "Ajuda, mas não é obrigatório. O principal é vontade de aprender e consistência.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Quando estiver pronto. Evitamos datas exatas para priorizar qualidade.",
      },
      {
        question: "Posso sugerir um projeto?",
        answer:
          "Pode sim! Levamos em conta a demanda e a capacidade da equipe.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Fale com a equipe pelo Discord. Quanto mais detalhes, melhor.",
      },
      {
        question: "A legenda não aparece. O que faço?",
        answer:
          "Verifique o player e o arquivo. Recomendamos players como MPV e VLC.",
      },
    ],
  },
];
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 pb-16 pt-20 md:px-10">
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-sm text-muted-foreground md:text-base">
                Respostas rápidas para dúvidas comuns sobre projetos, lançamentos e equipe.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="border-border/60 bg-card/80 shadow-lg">
              <CardContent className="space-y-4 p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Se sua dúvida não estiver aqui, fale com a equipe no Discord. Responderemos assim
                  que possível.
                </p>
                <div className="rounded-2xl border border-border/60 bg-background/60 p-4 text-sm text-muted-foreground">
                  A equipe é pequena e trabalha no tempo livre. Obrigado pela compreensão!
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/60 bg-card/80 shadow-lg">
              <CardContent className="space-y-4 p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Para melhor experiência, use players como MPV ou VLC e mantenha o arquivo na
                  mesma pasta da legenda.
                </p>
                <Separator className="bg-border/60" />
                <p className="text-sm text-muted-foreground">
                  Sugestões de projetos são bem-vindas, mas dependem de disponibilidade.
                </p>
              </CardContent>
            </Card>
          </div>
