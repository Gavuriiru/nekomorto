        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 pb-12 pt-12 md:px-10">
            <div className="max-w-3xl space-y-4">
              ...
              <h1 className="text-3xl font-semibold text-foreground md:text-5xl">{pageCopy.heroTitle}</h1>
              <p className="text-sm text-muted-foreground md:text-base">{pageCopy.heroSubtitle}</p>
            </div>
          </div>
        </section>
