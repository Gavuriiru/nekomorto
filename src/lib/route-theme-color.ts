...
const SECTION_HSL_OFFSETS: Record<ThemeColorSection, { h: number; s: number; l: number }> = {
  home: { h: 0, s: 0, l: 0 },
...
const normalizeAccentHex = (value: unknown) => {
...
export const resolveThemeColorSection = (pathname: unknown): ThemeColorSection => {
...
export const resolveRouteThemeColor = ({
  pathname,
  accentHex,
}: {
  pathname: unknown;
