...
const lexicalViewerLocalPatterns = [
  ...
  "/src/lexical-playground/nodes/TweetComponent.tsx",
  "/src/lexical-playground/nodes/TweetNode.ts",
  "/src/lexical-playground/nodes/YouTubeComponent.tsx",
  "/src/lexical-playground/nodes/YouTubeNode.ts",
