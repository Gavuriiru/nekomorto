...
export const ColorPicker = ({
  ...
  const panelContent = (
    <>
      ...
      >
        <ColorThumb className="absolute h-4 w-4 rounded-full border-2 border-white shadow-md data-dragging:scale-110 data-focus-visible:ring-2 data-focus-visible:ring-ring/45" />
      </ColorArea>
