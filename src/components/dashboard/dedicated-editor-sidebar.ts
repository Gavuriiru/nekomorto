...
export const dedicatedEditorSidebarPanelClassName =
  "overflow-hidden rounded-2xl border border-border/60 bg-card/80 shadow-editor-surface flex max-h-(--dedicated-editor-sidebar-height,34rem) min-h-0 flex-col";
