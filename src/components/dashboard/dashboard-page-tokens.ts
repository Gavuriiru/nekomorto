export const dashboardPageLayoutTokens = {
  ...
  headerBadge:
    "inline-flex items-center gap-3 rounded-full border border-border/60 bg-card/60 px-4 py-2 text-xs font-medium uppercase tracking-[0.3em] text-muted-foreground animate-fade-in",
