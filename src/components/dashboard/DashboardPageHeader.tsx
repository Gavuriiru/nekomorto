  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="mt-4 text-3xl font-semibold text-foreground lg:text-4xl motion-item">{title}</h1>
        {description ? (
          <p
      ...
      {actions ? (
        <div
          className="flex flex-wrap items-center gap-3 motion-item opacity-0"
