...
export const ChapterEditorStructureSection = ({
  ...
  <Accordion type="single" collapsible defaultValue="structure" className="project-editor-accordion space-y-2.5">
    <AccordionItem
      value="structure"
    ...
    >
      ...
      <AccordionContent className={structureContentClassName}>
        <div className="space-y-4">
          <div className="space-y-3 rounded-[20px] border border-border/50 bg-background/45 p-3.5">
            ...
            <div className="space-y-3" data-testid="chapter-structure-intro-row">
              ...
              <Button type="button" size="sm" variant="outline" onClick={onAddVolume} className="w-full justify-center">
                              ...
                              >
                                <div className="space-y-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <span>{chapterHasContent(episode) ? "Com leitura" : "Sem leitura"}</span>
