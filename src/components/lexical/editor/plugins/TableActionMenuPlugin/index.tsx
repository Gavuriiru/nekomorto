  ...
  if (cellMerge) {
    if (canMergeCells) {
      mergeCellButton = (
        ...
        >
          <span className="text">Mesclar células</span>
        </button>
      );
      ...
      mergeCellButton = (
        ...
        >
          <span className="text">Desfazer mesclagem</span>
        </button>
      );
    }
  }
  ...
  return createPortal(
    ...
    >
      ...
      <button
        ...
        className="item"
        onClick={() =>
          showColorPickerModal("Cor de fundo da célula", () => (
            <ColorPicker color={backgroundColor} onChange={handleCellBackgroundColor} />
          ))
        }
        data-test-id="table-background-color"
      >
        <span className="text">Cor de fundo</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Alternar listras de linha</span>
      </button>
      <DropDown
        buttonLabel="Alinhamento vertical"
        buttonClassName="item"
        buttonAriaLabel="Opções de alinhamento vertical"
      >
        <DropDownItem
          onClick={() => {
        ...
        >
          <div className="icon-text-container">
            ...
            <span className="text">Alinhar ao topo</span>
          </div>
        </DropDownItem>
        <DropDownItem
          onClick={() => {
        ...
        >
          <div className="icon-text-container">
            ...
            <span className="text">Alinhar ao meio</span>
          </div>
        </DropDownItem>
        <DropDownItem
          onClick={() => {
        ...
        >
          <div className="icon-text-container">
            ...
            <span className="text">Alinhar ao fundo</span>
          </div>
        </DropDownItem>
      </DropDown>
      <button
      ...
      >
        <span className="text">Alternar fixação da primeira linha</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Alternar fixação da primeira coluna</span>
      </button>
      <hr />
      <button
        type="button"
      ...
      >
        <span className="text">
          Inserir {selectionCounts.rows === 1 ? "linha" : `${selectionCounts.rows} linhas`} acima
        </span>
      </button>
      <button
        type="button"
      ...
      >
        <span className="text">
          Inserir {selectionCounts.rows === 1 ? "linha" : `${selectionCounts.rows} linhas`} abaixo
        </span>
      </button>
      <hr />
      <button
      ...
      >
        <span className="text">
          Inserir {selectionCounts.columns === 1 ? "coluna" : `${selectionCounts.columns} colunas`}{" "}
          à esquerda
        </span>
      </button>
      <button
      ...
      >
        <span className="text">Excluir coluna</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Excluir linha</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Excluir tabela</span>
      </button>
      <hr />
      <button
        type="button"
